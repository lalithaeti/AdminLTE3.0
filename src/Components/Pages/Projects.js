              ...
              <td>
                <ul className="list-inline">
                  <li className="list-inline-item">
                    <img alt="Avatar" className="table-avatar" src="assets/dist/img/avatar.png" />
                  </li>
                  <li className="list-inline-item">
                    <img alt="Avatar" className="table-avatar" src="assets/dist/img/avatar2.png" />
                  </li>
                  <li className="list-inline-item">
                    <img alt="Avatar" className="table-avatar" src="assets/dist/img/avatar3.png" />
                  </li>
                  <li className="list-inline-item">
                    <img alt="Avatar" className="table-avatar" src="assets/dist/img/avatar04.png" />
                  </li>
                </ul>
              </td>
            ...
            <tr>
              ...
              <td>
                <ul className="list-inline">
                  ...
                  <li className="list-inline-item">
                    <img alt="Avatar" className="table-avatar" src="assets/dist/img/avatar5.png" />
                  </li>
                </ul>
              </td>
              <td className="project_progress">
