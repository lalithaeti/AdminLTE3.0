      ...
      <div className="row mb-2">
        ...
        <div className="col-sm-6">
          <ol className="breadcrumb float-sm-right">
            ...
            <li className="breadcrumb-item active"><a href="/contact">Contacts</a></li>
          </ol>
        </div>
      </div>
    </div>{/* /.container-fluid */}
              ...
              <div className="card-body pt-0">
                <div className="row">
                  ...
                  <div className="col-5 text-center">
                    <img src="assets/dist/img/user1-128x128.jpg" alt className="img-circle img-fluid" />
                  </div>
                </div>
              </div>
            ...
            <div className="card bg-light">
              ...
              <div className="card-body pt-0">
                <div className="row">
                  ...
                  <div className="col-5 text-center">
                    <img src="assets/dist/img/user2-160x160.jpg" alt className="img-circle img-fluid" />
                  </div>
                </div>
              </div>
              <div className="card-footer">
