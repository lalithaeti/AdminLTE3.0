            ...
            <div className="card-body">
              <div className="direct-chat-messages">
                <div className="direct-chat-msg">
                  ...
                  <img className="direct-chat-img" src={require('../images/dashboard/user1-128x128.jpg')} alt="Message User Image" />
                ...
                <div className="direct-chat-msg right">
                  ...
                  <img className="direct-chat-img" src={require('../images/dashboard/user3-128x128.jpg')} alt="Message User Image" />
                  <div className="direct-chat-text">
              ...
              <div className="direct-chat-contacts">
                <ul className="contacts-list">
                  <li>
                    <a href="#">
                      <img className="contacts-list-img" src={require('../images/dashboard/user1-128x128.jpg')} />
      ...
      <div className="row">
          ...
          <div className="card card-widget widget-user-2">
            <div className="widget-user-header bg-warning">
              <div className="widget-user-image">
                <img className="img-circle elevation-2" src={require('../images/dashboard/user7-128x128.jpg')} alt="User Avatar" />
              </div>
        ...
        <div className="col-md-4">
          <div className="card card-widget widget-user">
            ...
            <div className="widget-user-image">
              <img className="img-circle elevation-2" src={require('../images/dashboard/user1-128x128.jpg')} alt="User Avatar" />
            </div>
            <div className="card-footer">
              <div className="row">
        ...
        <div className="col-md-4">
          <div className="card card-widget widget-user">
            <div className="widget-user-header text-white" style={{background: 'url("../images/dashboard/photo1.png") center center'}}>
              <h3 className="widget-user-username text-right">Elizabeth Pierce</h3>
              <h5 className="widget-user-desc text-right">Web Designer</h5>
            </div>
            <div className="widget-user-image">
              <img className="img-circle" src={require('../images/dashboard/user3-128x128.jpg')} alt="User Avatar" />
            </div>
            <div className="card-footer">
              <div className="row">
                <div className="col-sm-4 border-right">
          ...
          <div className="card card-widget">
            <div className="card-header">
              <div className="user-block">
                <img className="img-circle" src={require('../images/dashboard/user1-128x128.jpg')} alt="User Image" />
            ...
            <div className="card-body">
              <img className="img-fluid pad" src={require('../images/dashboard/photo2.png')} alt="Photo" />
            ...
            <div className="card-footer card-comments">
              <div className="card-comment">
                <img className="img-circle img-sm" src={require('../images/dashboard/user3-128x128.jpg')} alt="User Image" />
              ...
              <div className="card-comment">
                <img className="img-circle img-sm" src={require('../images/dashboard/user4-128x128.jpg')} alt="User Image" />
                <div className="comment-text">
                  <span className="username">
                    Luna Stark
                    <span className="text-muted float-right">8:03 PM Today</span>
            ...
            <div className="card-footer">
              <form action="#" method="post">
                <img className="img-fluid img-circle img-sm" src={require('../images/dashboard/user4-128x128.jpg')} alt="Alt Text" />
          ...
          <div className="card card-widget">
            ...
            <div className="card-body">
              ...
              <div className="attachment-block clearfix">
                <img className="attachment-img" src={require('../images/dashboard/photo1.png')} alt="Attachment Image" />
            ...
            <div className="card-footer card-comments">
              ...
              <div className="card-comment">
                <img className="img-circle img-sm" src={require('../images/dashboard/user5-128x128.jpg')} alt="User Image" />
                <div className="comment-text">
                  <span className="username">
                    Nora Havisham
                    <span className="text-muted float-right">8:03 PM Today</span>
