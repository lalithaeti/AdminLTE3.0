                ...
                <div className="card-body">
                  ...
                  <div className="direct-chat-contacts">
                    <ul className="contacts-list">
                      ...
                      <li>
                        <a href="#">
                          <img className="contacts-list-img" src={require('../images/dashboard/user7-128x128.jpg')} />
                          <div className="contacts-list-info">
                            <span className="contacts-list-name">
                              Sarah Doe
                      ...
                      <li>
                        <a href="#">
                          <img className="contacts-list-img" src={require('../images/dashboard/user3-128x128.jpg')} />
                          <div className="contacts-list-info">
                            <span className="contacts-list-name">
                              Nadia Jolie
                      ...
                      <li>
                        <a href="#">
                          <img className="contacts-list-img" src={require('../images/dashboard/user5-128x128.jpg')} />
                          <div className="contacts-list-info">
                            <span className="contacts-list-name">
                              Nora S. Vans
                      ...
                      <li>
                        <a href="#">
                          <img className="contacts-list-img" src={require('../images/dashboard/user6-128x128.jpg')} />
                          <div className="contacts-list-info">
                            <span className="contacts-list-name">
                              John K.
                      ...
                      <li>
                        <a href="#">
                          <img className="contacts-list-img" src={require('../images/dashboard/user8-128x128.jpg')} />
                          <div className="contacts-list-info">
                            <span className="contacts-list-name">
                              Kenneth M.
              ...
              <div className="card">
                ...
                <div className="card-body p-0">
                  <ul className="users-list clearfix">
                    <li>
                      <img src={require('../images/dashboard/user1-128x128.jpg')} alt="User Image" />
                      <a className="users-list-name" href="#">Alexander Pierce</a>
                      <span className="users-list-date">Today</span>
                    </li>
                    <li>
                      <img src={require('../images/dashboard/user8-128x128.jpg')} alt="User Image" />
                      <a className="users-list-name" href="#">Norman</a>
                      <span className="users-list-date">Yesterday</span>
                    </li>
                    <li>
                      <img src={require('../images/dashboard/user7-128x128.jpg')} alt="User Image" />
                      <a className="users-list-name" href="#">Jane</a>
                      <span className="users-list-date">12 Jan</span>
                    </li>
                    <li>
                      <img src={require('../images/dashboard/user6-128x128.jpg')} alt="User Image" />
                      <a className="users-list-name" href="#">John</a>
                      <span className="users-list-date">12 Jan</span>
                    </li>
                    <li>
                      <img src={require('../images/dashboard/user2-160x160.jpg')} alt="User Image" />
                    ...
                    <li>
                      <img src={require('../images/dashboard/user4-128x128.jpg')} alt="User Image" />
                      <a className="users-list-name" href="#">Nora</a>
                      <span className="users-list-date">15 Jan</span>
                    </li>
                    <li>
                      <img src={require('../images/dashboard/user3-128x128.jpg')} alt="User Image" />
              ...
              <ul className="products-list product-list-in-card pl-2 pr-2">
                <li className="item">
                  <div className="product-img">
                    <img src={require('../images/dashboard/default-50x50.gif')} alt="Product Image" className="img-size-50" />
                  </div>
